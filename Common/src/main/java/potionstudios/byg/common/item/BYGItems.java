...
public class BYGItems {
    ...
    private static final Component AMETRINE_UPGRADE = Component.translatable(Util.makeDescriptionId("upgrade", BYG.createLocation("ametrine_upgrade")))
            .withStyle(TITLE_FORMAT);
    private static final Component AMETRINE_UPGRADE_APPLIES_TO = Component.translatable(
                    Util.makeDescriptionId("item", BYG.createLocation("smithing_template.ametrine_upgrade.applies_to"))
            )
            .withStyle(DESCRIPTION_FORMAT);
    private static final Component AMETRINE_UPGRADE_INGREDIENTS = Component.translatable(
                    Util.makeDescriptionId("item", BYG.createLocation("smithing_template.ametrine_upgrade.ingredients"))
            )
            .withStyle(DESCRIPTION_FORMAT);
    private static final Component AMETRINE_UPGRADE_BASE_SLOT_DESCRIPTION = Component.translatable(
            Util.makeDescriptionId("item", BYG.createLocation("smithing_template.ametrine_upgrade.base_slot_description"))
    );
    private static final Component AMETRINE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(
            Util.makeDescriptionId("item", BYG.createLocation("smithing_template.ametrine_upgrade.additions_slot_description"))
    );
    public static final RegistryObject<Item> AMETRINE_UPGRADE_SMITHING_TEMPLATE = createItem(() -> new SmithingTemplateItem(
            AMETRINE_UPGRADE_APPLIES_TO,
            AMETRINE_UPGRADE_INGREDIENTS,
            AMETRINE_UPGRADE,
            AMETRINE_UPGRADE_BASE_SLOT_DESCRIPTION,
            AMETRINE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION,
            List.of(EMPTY_SLOT_HELMET, EMPTY_SLOT_CHESTPLATE, EMPTY_SLOT_LEGGINGS, EMPTY_SLOT_BOOTS),
            List.of(EMPTY_SLOT_INGOT)
    ), "ametrine_upgrade_smithing_template");
    ...
    private static final Component PENDORITE_UPGRADE = Component.translatable(Util.makeDescriptionId("upgrade", BYG.createLocation("pendorite_upgrade")))
            .withStyle(TITLE_FORMAT);
    private static final Component PENDORITE_UPGRADE_APPLIES_TO = Component.translatable(
                    Util.makeDescriptionId("item", BYG.createLocation("smithing_template.pendorite_upgrade.applies_to"))
            )
            .withStyle(DESCRIPTION_FORMAT);
    private static final Component PENDORITE_UPGRADE_INGREDIENTS = Component.translatable(
                    Util.makeDescriptionId("item", BYG.createLocation("smithing_template.pendorite_upgrade.ingredients"))
            )
            .withStyle(DESCRIPTION_FORMAT);
    private static final Component PENDORITE_UPGRADE_BASE_SLOT_DESCRIPTION = Component.translatable(
            Util.makeDescriptionId("item", BYG.createLocation("smithing_template.pendorite_upgrade.base_slot_description"))
    );
    private static final Component PENDORITE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(
            Util.makeDescriptionId("item", BYG.createLocation("smithing_template.pendorite_upgrade.additions_slot_description"))
    );
    public static final RegistryObject<Item> PENDORITE_UPGRADE_SMITHING_TEMPLATE = createItem(() -> new SmithingTemplateItem(
            PENDORITE_UPGRADE_APPLIES_TO,
            PENDORITE_UPGRADE_INGREDIENTS,
            PENDORITE_UPGRADE,
            PENDORITE_UPGRADE_BASE_SLOT_DESCRIPTION,
            PENDORITE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION,
            List.of(EMPTY_SLOT_AXE, EMPTY_SLOT_PICKAXE, EMPTY_SLOT_SWORD, EMPTY_SLOT_SHOVEL, EMPTY_SLOT_HOE),
            List.of(EMPTY_SLOT_INGOT)
    ), "pendorite_upgrade_smithing_template");
