...
//            } else {
            ...
            for (lvt_9_5_ = 0; lvt_9_5_ < 16; ++lvt_9_5_) {
                for (lvt_10_5_ = 0; lvt_10_5_ < 16; ++lvt_10_5_) {
                    for (lvt_11_4_ = 0; lvt_11_4_ < 8; ++lvt_11_4_) {
                        ...
                        if (lvt_12_4_) {
                            BlockState lvt_13_1_ = world.getBlockState(blockPos.offset(lvt_9_5_, lvt_11_4_, lvt_10_5_));
                            if (lvt_11_4_ >= 4 && !lvt_13_1_.getFluidState().isEmpty()) {
                                return false;
                            }
            ...
            if (blockStateFeatureConfig.state.getFluidState().is(FluidTags.WATER)) {
                for (lvt_9_5_ = 0; lvt_9_5_ < 16; ++lvt_9_5_) {
                    for (lvt_10_5_ = 0; lvt_10_5_ < 16; ++lvt_10_5_) {
