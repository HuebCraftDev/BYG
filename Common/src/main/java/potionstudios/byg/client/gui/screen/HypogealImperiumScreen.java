...
public class HypogealImperiumScreen extends AbstractContainerScreen<HypogealImperiumContainer> {
    ...
    @Override
    public void render(@NotNull GuiGraphics guiGraphics, final int mouseX, final int mouseY, final float partialTicks) {
    ...
    @Override
    protected void renderBg(@NotNull GuiGraphics guiGraphics, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
