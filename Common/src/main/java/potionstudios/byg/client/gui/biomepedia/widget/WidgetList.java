...
public class WidgetList extends BYGContainerObjectSelectionList<WidgetList.Entry> {
    ...
    @Override
    protected void renderList(@NotNull GuiGraphics guiGraphics, int $$1, int $$2, float $$3) {
    }
    ...
    public static class Entry extends ContainerObjectSelectionList.Entry<Entry> {
        ...
        @Override
        public void render(@NotNull GuiGraphics guiGraphics, int pIndex, int pTop, int pLeft, int rowWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTick) {
