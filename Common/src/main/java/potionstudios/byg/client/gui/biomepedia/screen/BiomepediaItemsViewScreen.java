            ...
            for (int pageSide = 0; pageSide < pagePair.length; pageSide++) {
                ...
                for (ItemWidget[] row : page) {
                    ...
                    for (int columnIdx = 0; columnIdx < row.length; columnIdx++) {
                        ...
                        ItemWidget itemWidget = new ItemWidget(bygItems[registryIdx].get().getDefaultInstance(), this.minecraft.getItemRenderer(), xOffset + startX, yOffset, buttonSize, buttonSize, button -> {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        forEach(items, itemWidget -> {
            if (itemWidget.isMouseOver(mouseX, mouseY)) {
                ...
                guiGraphics.renderTooltip(this.minecraft.font, tooltipLines, itemWidget.stack.getTooltipImage(), mouseX, mouseY);
            }
        });
    }
